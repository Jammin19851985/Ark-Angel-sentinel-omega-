        ...
        <div id={id} className="h-full flex flex-col bg-black/60 p-2 rounded border border-slate-800 tech-panel min-h-[150px]">
            ...
            <div className="grid grid-cols-2 gap-1 mb-1">
                <div className="bg-black/40 p-1 rounded border border-slate-800">
                    <div className="text-[8px] text-slate-500 font-mono">PNL</div>
                    <div className={`text-xs font-mono font-bold ${totalPnl >= 0 ? 'text-neon-green' : 'text-red-400'}`}>
                        ${totalPnl.toFixed(2)}
                    </div>
                </div>
                <div className="bg-black/40 p-1 rounded border border-slate-800">
            ...
            <div className="flex-1 overflow-hidden relative border border-slate-800 rounded bg-[#08080a]">
