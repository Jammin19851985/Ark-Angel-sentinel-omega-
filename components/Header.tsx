                ...
                <div className="flex items-center justify-between h-12">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[8px] font-mono text-slate-500 tracking-[0.4em] uppercase">Omega Manifestation</span>
                        </div>
                        {isSovereign && (
                            <div className="hidden md:flex items-center px-2 py-0.5 ml-3 border border-violet-500/50 bg-violet-950/20 rounded-sm">
                                ...
                                <span className="text-[8px] font-bold text-violet-300 tracking-widest">SOVEREIGN STATE</span>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        {isGodMode && (
                            <div className="relative group">
                                ...
                                <button className="cyber-key px-2 py-1 flex items-center gap-1.5 text-amber-500 border-amber-800" title="Visual Settings">
                                    <VideoIcon className="w-3 h-3" />
                                    <span className="hidden sm:inline text-[9px]">VISUALS</span>
                                </button>
                            </div>
                        )}
