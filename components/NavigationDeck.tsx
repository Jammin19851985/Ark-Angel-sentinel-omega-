...
const CyberKey: React.FC<{view: ActiveView, label: string, icon: React.ReactNode, id: string, activeView: ActiveView, onClick: () => void, isNew?: boolean }> = ({ view, label, icon, id, activeView, onClick, isNew }) => {
